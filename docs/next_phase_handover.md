...
- latest landed polish slice: the framebuffer shell now uses a tighter frame with a compact header, wider transcript area, and simplified readouts while the existing bootstrap font still gets a subtle shadow pass
